<?php
include 'paginas/rodrigosilvaconfig.php';
?> 
<!doctype html>
<html>
<head>
...
<li><a href="../paginas/team.php">Nossa Team</a></li>
</li>
<li><a href="../paginas/ranking1.php">Ranking</a></li>
...
<section class="main-section container-service" id="service"><!--main-section-start-->
	<div class="container">
    	...
    	<h6>
    	  <div class="col2">
        	<h4><iframe width='430' height='330' frameborder='0' src='http://127.0.0.1/noticias/noticia.php'></iframe><br>
        	</h4>
        </div>
	...
	<div class="container">
    	<div class="row">
		  ...
		  <div class="col-lg-7 col-sm-8 featured-work">
			  <div class="col-lg-7 col-sm-8 featured-work">
			    <p class="padding-b">Armas limitadas:</p>
			    <div class="featured-box">
			      ...
			      <div class="featured-box-col2 wow fadeInRight delay-02s">
			        <h3 class="pack-ouro">Arsenal demom</h3>
			        <p>KRISS+CHEYTAC+AUG+FANG+FACA DE OSSO</p>
		          </div>
		        </div>
			    <div class="featured-box">
			      <div class="featured-box-col2 wow fadeInRight delay-04s">
			        <h3 class="pack-prata">ARSENAL LOVE</h3>
			        <p>KRISS+AUG</p>
		          </div>
		        </div>
			    <div class="featured-box">
			      <div class="featured-box-col2 wow fadeInRight delay-06s">
			        <h3 class="pack-bronze">ARSENAL FGX</h3>
			        <p>SLA ;-;</p>
		          </div>
		        </div>
			    <div class="featured-box desc">
			      <div class="featured-box-col2 wow fadeInRight delay-06s">
			        <p>COLE AKI SLIDESHOW</p>
		          </div>
		        </div>
		    </div>
			  <P class="padding-b">&nbsp;</P>
